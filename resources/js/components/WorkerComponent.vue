    ...
    <div class="container">
        <div class="section" v-if="render1 == true">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input is-success" type="text" maxlength="13" v-model="new_user.rfc">
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <div class="select">
                        <select  v-model="new_user.rol_selected">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(cliente,num) in lista">
                                    ...
                                    <td><button class="button is-link is-rounded" v-on:click="actualiza(cliente.nombre,cliente.rfc,cliente.trabajador,cliente.usuario)">Actualizar</button></td>
...
<script>
    export default {
        ...
        methods:{
            ...
            postUser(){
                this.$http.post('api/post_trabajador',{
                    name: this.new_user.usuario,
                    pass:this.new_user.password,
                    rol:this.new_user.rol_selected,
            ...
            clear_new(){
             ...
             getLista(){
                this.$http.get('api/get_lista_tr').then(response => {
                    this.lista = response.data;
                }).catch(error => console.log(error))
            },
            actualiza(nombre,rfc,cliente,usuario){
                this.$http.post('api/put_trabajador',{
                    name:nombre,
                    rfc:rfc,
                    usr:usuario,
                    cl:cliente
            ...
            eliminar(id){
                this.$http.post('api/delete_trabajador',{
                    cl:id,
                }).then(response => {
                    this.lista = response.data;
                    this.getLista();
